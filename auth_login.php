<?php
// Unified login page with session security
session_start();
...
<head>
    ...
    <title>Login - PSG Polytechnic College</title>
...
<body>
    <div class="login-container">
        <div class="login-header">
            <h1><i class="fa-solid fa-graduation-cap"></i> PSG Polytechnic</h1>
            <p>Department Portal Login</p>
        </div>
        ...
        <div class="register-link">
            Don't have an account? <a href="auth_register.php">Register here</a>
        </div>
    </div>
</body>
</html>
